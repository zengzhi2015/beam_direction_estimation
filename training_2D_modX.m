...
MU_Z = zeros(1,length(THETA)*length(XPOS));
SIGMA_XX = zeros(1,length(THETA)*length(XPOS)); 
SIGMA_YY = zeros(1,length(THETA)*length(XPOS));
SIGMA_ZZ = zeros(1,length(THETA)*length(XPOS));
SIGMA_XY = zeros(1,length(THETA)*length(XPOS));
SIGMA_XZ = zeros(1,length(THETA)*length(XPOS));
SIGMA_ZY = zeros(1,length(THETA)*length(XPOS));
